class AllTransactionModel {
  ...
  late final List<AllTransactionData> data;
  late final String status;
  late final String message;

  AllTransactionModel.fromJson(Map<String, dynamic> json){
    data = List.from(json['data']??{}).map((e)=>AllTransactionData.fromJson(e)).toList();
    status = json['status']??'';
...
class AllTransactionData {
  ...
  AllTransactionData.fromJson(Map<String, dynamic> json){
    id = json['id']??0;
